...
/*
  let pari=[1, 25, 36, 12, 24, 87, 36];
for (let index = 0; index <=pari.length < 50; index++) {
  if (pari[index]%2===0){
...
let randomNum5 = Math.floor(Math.random()*10)
let randomNum6 = Math.floor(Math.random()*10)
let randomNum7 = Math.floor(Math.random()*10)
let randomNum8 = Math.floor(Math.random()*10)
let randomNum9 = Math.floor(Math.random()*10)
let randomNum10 = Math.floor(Math.random()*10)
for (let i = 0; i < 1; i ++) {
  
  x.push(randomNum, randomNum2, randomNum3, randomNum4, randomNum5, randomNum6, randomNum7, randomNum8, randomNum9, randomNum10)
}
console.log(x);
